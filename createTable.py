...
def create_current_table():
    dbPostgres.create('public.current_temperature', 'site integer', 'timestamp_measured timestamp without time zone',
                      'value integer', 'timestamp_record timestamp with time zone DEFAULT now()')
    dbPostgres.create('public.current_condition', 'site integer', 'timestamp_measured timestamp without time zone',
                      'value character varying', 'timestamp_record timestamp with time zone DEFAULT now()')
...
def create_system_table():
    dbPostgres.create('public.sysinfo', "value character varying", 'timestamp_record timestamp with time zone DEFAULT now()')