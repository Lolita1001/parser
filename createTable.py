...
def insert_PK_all_tables():
    dbPostgres.alter('current_temperature', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('current_condition', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('current_temperature_feels', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('current_pressure', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('current_humidity', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_morning_minimum', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_morning_maximum', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_morning_condition', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_morning_pressure', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_morning_humidity', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_morning_feeling', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_day_minimum', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_day_maximum', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_day_condition', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_day_pressure', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_day_humidity', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_day_feeling', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_evening_minimum', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_evening_maximum', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_evening_condition', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_evening_pressure', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_evening_humidity', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_evening_feeling', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_night_minimum', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_night_maximum', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_night_condition', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_night_pressure', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_night_humidity', 'id SERIAL', 'PRIMARY KEY')
    dbPostgres.alter('calendar_T_night_feeling', 'id SERIAL', 'PRIMARY KEY')